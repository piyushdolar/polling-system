            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item">
                                <a href="{{ route('home') }}" class="nav-link">Create Questions</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('answer.index') }}" class="nav-link">Take A Poll</a>
                            </li>
                            <li class="nav-item">
                                <a href='{{route("answer.result")}}' class="nav-link">Result</a>
                            </li>
